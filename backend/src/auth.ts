...
export type Role = 'ADMIN' | 'CREDIT_COACH' | 'LENDER_REVIEWER' | 'BORROWER' | 'VIEWER';
export type Permission = 'read' | 'write' | 'admin';

const roles = ["ADMIN","CREDIT_COACH","LENDER_REVIEWER","BORROWER","VIEWER"] as Role[];
...
function authSecret() {
  return process.env.DEMO_AUTH_SECRET || 'cashflow-memory-local-demo-secret';
}

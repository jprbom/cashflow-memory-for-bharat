...
These endpoints simulate PG checkout, PA payment attempts, TPAP app authorization, PSP/bank outcomes, NPCI-style UPI rail states, HMAC webhooks, settlement, refunds, disputes, duplicate delivery, out-of-order webhook handling, and synthetic settlement events for cashflow memory.
...
This repository implements list, create, update, and delete operations for merchant profiles and cashflow entries. Write endpoints require write permission. Delete endpoints require admin permission.
